...
public class Sort01 {
    ...
    public static String solution(int[] numbers) {
        ...
        int[][] doubleArr = {{1,7}, {3,2}, {5,6}};
        Arrays.sort(doubleArr, (a1, a2) -> (a1[1] - a2[1]));
        ...
        Integer[] temp2 = Arrays.stream(numbers).boxed().toArray(Integer[] :: new);
        Arrays.stream(numbers).boxed().sorted(Integer::compareTo);
